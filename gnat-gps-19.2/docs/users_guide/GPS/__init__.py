...
class __enum_proxy(object):
    def __init__(self, name, **enums):
        for k, v in six.iteritems (enums):
    ...
    def __init__(self, name, force=False, on_input=None, on_destroy=None,
        ...
        - :func:`on_key` is a function called every time the user
          ...
          - $3: "key": this is the unicode character that the user
            ...
            :command:`six.unichr(key).encode("utf8")` to get a string
...
if six.PY2:
    exception_parent = exceptions.Exception
else:
    exception_parent = Exception
class Exception(exception_parent):
...
class Project(object):
   ...
   - project_changed
    ...
    def get_attribute_as_string(self, attribute, package='', index=''):
        ...
        When the attribute is not explicitly overridden in the project, the
...
class Timeout(object):
    ...
    .. code-block:: python
       ...
       def callback(timeout):
          ...
          timeout.occur += 1
          print ("A timeout occur=" + repr (timeout.occur))
          if timeout.occur == 3:
             timeout.remove()
...
def get_system_dir():
    ...
    .. code-block:: python
       ...
       html = GPS.get_system_dir() + "share/doc/gnat-gps/html/gps-welcome.html"
