...
package body Language.Libclang is
   ...
   Clang_Vsn_Min : constant String
     := Integer'Image (clang_c_Index_h.CINDEX_VERSION_MAJOR);
   Clang_Vsn_Maj : constant String
     := Integer'Image (clang_c_Index_h.CINDEX_VERSION_MINOR);
   Clang_Vsn_Str : constant String (1 .. 10) :=
     Clang_Vsn_Maj (Clang_Vsn_Maj'First + 1 .. Clang_Vsn_Maj'Last) & "."
     & Clang_Vsn_Min (Clang_Vsn_Min'First + 1 .. Clang_Vsn_Min'Last)
     & (Clang_Vsn_Maj'Length + Clang_Vsn_Min'Length .. 10 => ' ');
      ...
      begin
         ...
         begin
            ...
            if Marker /= Cache_Constant_Marker then
               ...
               if Version = Clang_Vsn_Str then
                  Validated := True;
               else
                  Trace (Me, "Cache version: " & Version & ASCII.LF
                         & "Clang version: " & Clang_Vsn_Str
   ...
   begin
      ...
      String'Output (Cache_Stream, Clang_Vsn_Str);
   ...
   begin
      ...
      Set_Address_Return_Value (Data, CTU.all'Address);
