...
package body GVD.Process is
   ...
   function Spawn
     (Kernel          : access GPS.Kernel.Kernel_Handle_Record'Class;
      Preferred_Kind  : GVD.Types.Debugger_Type;
   ...
   is
      ...
      --  Get debugger kind according to executable and preferred kind
      ...
      begin
         if Is_LLDB then
            ...
            if Preferred_Kind /= GVD.Types.LLDB then
